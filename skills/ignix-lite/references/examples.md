...
## `build_validated` - Build, Auto-correct, and Preview

**Call:**
```json
{
  "tool": "build_validated",
  "arguments": {
    "description": "a user profile card with an avatar and name",
    "options": {
      "preview": true,
      "width": 320,
      "theme": "light"
...
```json
{
  "emmet": "article>img[slot=avatar data-size=md src=? alt=?]+span[slot=title]{Name}",
  "html": "<article>\n  <img slot=\"avatar\" data-size=\"md\" src=\"\" alt=\"User avatar\">\n  <span slot=\"title\">Name</span>\n</article>",
  "components_used": ["card", "avatar"],
  "validation": {
    "valid": true,
    "score": 100,
    "errors": []
...
## `get_token_cost` - Compare token footprint to Tailwind CSS
...
```json
{
  "tool": "get_token_cost",
  "arguments": {
    "html": "<article>\n  <span slot=\"title\">Welcome</span>\n  <p slot=\"body\">Main text content</p>\n</article>"
  }
}
```
...
```json
{
  "ignix_html": "<article>\n  <span slot=\"title\">Welcome</span>\n  <p slot=\"body\">Main text content</p>\n</article>",
  "ignix_tokens": 20,
  "tailwind_html_estimate": "<article class=\"p-6 bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col gap-4\">\n  <span slot=\"title\">Welcome</span>\n  <p slot=\"body\">Main text content</p>\n</article>",
  "tailwind_tokens_estimate": 43,
  "tokens_saved": 23,
  "savings_percentage": "53.5%",
  "tokens_used": 15
}
```
