...
const tokens = readJSON('skills/ignix-lite/assets/design-tokens.json')
if (tokens) {
...
const intents = readJSON('skills/ignix-lite/assets/intents.json')
...
const guide = readText('skills/ignix-lite/references/api-guide.md')
if (guide) {
...
const examples = readText('skills/ignix-lite/references/examples.md')
if (examples) {
  for (const tool of REQUIRED_TOOLS) {
...
console.log('\nCheck 5: SKILL.md ')
const skill = readText('skills/ignix-lite/SKILL.md')
if (skill !== null) {
...
const template = readText('skills/ignix-lite/templates/component.html.template')
if (template !== null) {
